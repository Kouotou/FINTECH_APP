...
void main() {
  group('Mock Authentication', () {
    ...
    test(
      'Should be able to initialized in less than two seconds',
      () async {
        await provider.initialize();
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn({
    ...
    if (!_isInitialized) throw NotInitializedException();
    if (email == 'bilal@example.com') throw UserNotFoundAuthException();
    if (email == 'test12') throw WrongPasswordAuthException();
